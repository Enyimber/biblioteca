                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="<?php echo base_url('index.html'); ?>" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
                                        <hr>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url('forgot-password.html'); ?>">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url('register.html'); ?>">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
