                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                Libros disponibles:
                                <select name="listageneros" id="listageneros" class="form-control">
                                    <?php foreach ($genero as $key) {
                                        echo '<option value="' . $key->genero . '">' . $key->genero . '</option>';
                                    } ?>
                                </select>
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                        <table id="lista" class='table table-bordered dataTable'>
